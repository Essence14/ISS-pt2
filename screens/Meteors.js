...
import { Text, View, Alert, SafeAreaView, FlatList, Platform, Image, ImageBackground } from 'react-native';
    ...
    return(
        ...
        <View>
            ...
            <Text style={[styles.cardText,{marginTop:20,marginLeft:50}]}>
               closestToEarth- {item.close_approach_data[0].close_approach_data_full}
            </Text>
            <Text style={[styles.cardText,{marginTop:5,marginLeft:50}]}>
               MinimumDiameter(kilometers)- {item.estimated_diameter.kilometers.estimated_diameter_min}
            </Text>
            <Text style={[styles.cardText,{marginTop:5,marginLeft:50}]}>
               MaximumDiameter(kilometers)- {item.estimated_diameter.kilometers.estimated_diameter_max}
            </Text>
            <Text style={[styles.cardText,{marginTop:5,marginLeft:50}]}>
               Velocity(kmph)- {item.close_approach_data[0].relative_velocity.kilometers_per_hours}
            </Text>
            <Text style={[styles.cardText,{marginTop:5,marginLeft:50}]}>
